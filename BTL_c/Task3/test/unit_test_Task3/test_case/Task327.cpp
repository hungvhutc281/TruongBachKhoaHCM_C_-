...
bool UNIT_TEST_Task3::Task327() {
    ...
    for (int i = 0; i < 8; i++) {
        output << unitsARVN[i]->str() << "\n";
    }
    for (int i = 0; i < 9; i++) {
        output << unitsLib[i]->str() << "\n";
    }
    ...
    string expect = "Infantry[infantryType=REGULARINFANTRY,quantity=27,weight=5,position=(6,6)]\nInfantry[infantryType=REGULARINFANTRY,quantity=9,weight=5,position=(10,6)]\nInfantry[infantryType=REGULARINFANTRY,quantity=9,weight=5,position=(12,6)]\nInfantry[infantryType=SPECIALFORCES,quantity=24,weight=5,position=(8,8)]\nInfantry[infantryType=SPECIALFORCES,quantity=12,weight=5,position=(11,11)]\nVehicle[vehicleType=ARTILLERY,quantity=30,weight=5,position=(6,6)]\nVehicle[vehicleType=ARTILLERY,quantity=10,weight=5,position=(8,6)]\nVehicle[vehicleType=ARTILLERY,quantity=10,weight=5,position=(10,10)]\nInfantry[infantryType=REGULARINFANTRY,quantity=180,weight=5,position=(2,2)]\nInfantry[infantryType=REGULARINFANTRY,quantity=90,weight=5,position=(6,6)]\nInfantry[infantryType=SNIPER,quantity=12,weight=5,position=(0,1)]\nInfantry[infantryType=MORTARSQUAD,quantity=6,weight=7,position=(0,2)]\nInfantry[infantryType=SPECIALFORCES,quantity=4,weight=9,position=(0,3)]\nInfantry[infantryType=REGULARINFANTRY,quantity=184,weight=10,position=(0,3)]\nVehicle[vehicleType=ANTIAIRCRAFT,quantity=6,weight=7,position=(0,2)]\nVehicle[vehicleType=ARTILLERY,quantity=3,weight=10,position=(0,3)]\nVehicle[vehicleType=TANK,quantity=2,weight=11,position=(0,4)]\n";
